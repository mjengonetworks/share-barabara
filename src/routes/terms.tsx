...
function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <h1 className="mt-2 text-4xl font-extrabold">Terms of use</h1>
      <div className="mt-6 space-y-6 text-sm text-foreground/90">
        <section>
          <h2 className="text-lg font-bold">Using Share Barabara</h2>
          <p className="mt-2">
            Share Barabara is a community platform. Reading news, alerts, reports and statistics
            is free and open to everyone. Posting alerts, filing reports, writing articles,
            commenting and rating other contributors requires an account.
          </p>
        </section>
        <section>
          ...
          <p className="mt-2">
            ...
            accuracy or completeness of community-submitted content, and aims not to miss
            incidents rather than to cover every one.
          </p>
        </section>
        <section>
          ...
          <p className="mt-2">
            ...
            safety. Do not impersonate another person. Moderators and admins may edit, unverify,
            or remove content, and may suspend accounts that misuse the platform.
          </p>
        </section>
        <section>
