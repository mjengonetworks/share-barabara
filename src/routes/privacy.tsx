...
function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <p className="text-xs font-semibold uppercase tracking-widest text-accent-foreground">Legal</p>
      ...
      <div className="mt-6 space-y-6 text-sm text-foreground/90">
        <section>
          ...
          <p className="mt-2">
            ...
            county or avatar you choose to add. When you sign in with Google, we receive your
            name, email and profile picture from Google. When you submit an alert, report,
            article, comment or video, we store the content you submit and, where you allow
            location access, the coordinates you share.
          </p>
        </section>
        <section>
          <h2 className="text-lg font-bold">Cookies</h2>
          <p className="mt-2">
            We use a small number of cookies and local storage entries to keep you signed in and
            to remember preferences such as notification settings. We do not currently use
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            profile, notifying you about activity relevant to you, and moderating submitted
            content. Alerts you submit are shown publicly. Accident reports and articles are
            reviewed before publication, and may be edited by a moderator or editor for accuracy
            or clarity.
          </p>
        </section>
        <section>
