...
export const Route = createFileRoute("/_authenticated/dashboard")({
  head: () => ({
    meta: [
      { title: "My Dashboard — Barabara Salama" },
      {
        name: "description",
        content: "Your submitted road hazard alerts, accident reports and comments on Barabara Salama.",
      },
      { property: "og:title", content: "My Dashboard — Barabara Salama" },
      {
