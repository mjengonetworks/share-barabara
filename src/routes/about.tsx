  ...
  head: () => ({
    meta: [
      { title: "About: Share Barabara" },
      {
        name: "description",
        content:
          "About Share Barabara, a Mjengo Networks Limited platform for road safety in Kenya.",
      },
    ],
  }),
  component: AboutPage,
    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="mt-6 space-y-4 text-foreground/90">
        <p>
          ...
          part of Mjengo Networks Limited. We bring together live hazard alerts, verified accident
          reports, open crash statistics and road safety news, built by the people who use Kenyan
          roads every day.
        </p>
        <p>
          Our mission is simple: promoting safer roads for all. Every journey home should end at
          home. We believe conscious daily choices, by drivers, riders, pedestrians and everyone in
          between, save lives, and that better information about what is actually happening on the
          road helps people make those choices.
        </p>
        <p>
        ...
        <p>
          ...
          <Link to="/partner-with-us" className="underline">
            Get in touch
          </Link>{" "}
          or email{" "}
